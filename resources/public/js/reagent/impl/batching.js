...
{var C_5455 = (a[i]);if(cljs.core.truth_(C_5455.cljsIsDirty))
{C_5455.forceUpdate();
} else
{}
{
...
reagent.impl.batching.dispose = (function dispose(C){var ratom_5457 = C.cljsRatom;if(!((ratom_5457 == null)))
{reagent.ratom.dispose_BANG_.call(null,ratom_5457);
} else
{}
