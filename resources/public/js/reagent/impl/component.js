...
reagent.impl.component.do_render = (function do_render(C){var _STAR_current_component_STAR_5441 = reagent.impl.component._STAR_current_component_STAR_;try{reagent.impl.component._STAR_current_component_STAR_ = C;
var f = (C[reagent.impl.component.cljs_render]);var _ = ((reagent.impl.util.clj_ifn_QMARK_.call(null,f))?null:(function(){throw (new Error(("Assert failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol("util","clj-ifn?","util/clj-ifn?",259370460,null),new cljs.core.Symbol(null,"f","f",43394975,null)))))))})());var p = reagent.impl.util.js_props.call(null,C);var res = ((((C["componentFunction"]) == null))?f.call(null,C):(function (){var argv = (p[reagent.impl.util.cljs_argv]);var n = cljs.core.count.call(null,argv);var G__5442 = n;switch (G__5442) {
case (1):
return f.call(null);
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_5441;
}});
reagent.impl.component.custom_wrapper = (function custom_wrapper(key,f){var G__5445 = (((key instanceof cljs.core.Keyword))?key.fqn:null);switch (G__5445) {
case "componentWillUnmount":
return ((function (G__5445){
...
{return (function() { 
var G__5447__delegate = function (args){var C = this;return cljs.core.apply.call(null,f,C,args);
};
...
{var G__5450 = f;(G__5450["__reactDontBind"] = true);
return G__5450;
} else
{return f;
}
...
reagent.impl.component.map_to_js = (function map_to_js(m){return cljs.core.reduce_kv.call(null,(function (o,k,v){var G__5452 = o;(G__5452[cljs.core.name.call(null,k)] = v);
return G__5452;
}),{},m);
});
...
return (function() { 
var G__5453__delegate = function (args){return as_component.call(null,cljs.core.apply.call(null,cljs.core.vector,res,args));
};
