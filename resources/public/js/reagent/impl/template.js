...
{return (function() { 
var G__5458__delegate = function (args){return cljs.core.apply.call(null,v,args);
};
...
{return cljs.core.reduce_kv.call(null,(function (res,k,v){var G__5461 = res;(G__5461[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
return G__5461;
}),{},val);
} else
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__5462){var vec__5464 = p__5462;var id = cljs.core.nth.call(null,vec__5464,(0),null);var class$ = cljs.core.nth.call(null,vec__5464,(1),null);var pid = (props["id"]);(props["id"] = ((!((pid == null)))?pid:id));
if((class$ == null))
{return null;
} else
...
{if(new cljs.core.Keyword(null,"else","else",-1508377146))
{var objprops = cljs.core.reduce_kv.call(null,(function (o,k,v){var pname_5465 = reagent.impl.template.cached_prop_name.call(null,k);if(!((pname_5465 === "key")))
{(o[pname_5465] = reagent.impl.template.convert_prop_value.call(null,v));
} else
{}
return o;
...
var G__5468 = jsprops;(G__5468["defaultValue"] = value);
(G__5468["value"] = null);
(G__5468["onChange"] = ((function (G__5468,on_change,value){
return (function (p1__5466_SHARP_){return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__5466_SHARP_);
});})(G__5468,on_change,value))
);
return G__5468;
}
});
...
reagent.impl.template.add_input_methods = (function add_input_methods(spec){var G__5470 = spec;(G__5470["componentDidUpdate"] = ((function (G__5470){
return (function (){var C = this;return reagent.impl.template.input_did_update.call(null,C);
});})(G__5470))
);
(G__5470["componentWillUnmount"] = ((function (G__5470){
...
return (function (p1__5471_SHARP_,p2__5472_SHARP_){var C = this;return reagent.impl.template.wrapped_should_update.call(null,C,p1__5471_SHARP_,p2__5472_SHARP_);
...
reagent.impl.template.parse_tag = (function parse_tag(hiccup_tag){var vec__5474 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));var tag = cljs.core.nth.call(null,vec__5474,(0),null);var id = cljs.core.nth.call(null,vec__5474,(1),null);var class$ = cljs.core.nth.call(null,vec__5474,(2),null);var comp = (reagent.impl.template.DOM[tag]);var class_SINGLEQUOTE_ = (cljs.core.truth_(class$)?clojure.string.replace.call(null,class$,/\./," "):null);if(cljs.core.truth_(comp))
{} else
...
reagent.impl.template.get_wrapper = (function get_wrapper(tag){var vec__5476 = reagent.impl.template.parse_tag.call(null,tag);var comp = cljs.core.nth.call(null,vec__5476,(0),null);var id_class = cljs.core.nth.call(null,vec__5476,(1),null);return reagent.impl.template.wrap_component.call(null,comp,id_class,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag)));
});
...
var c = reagent.impl.template.as_class.call(null,cljs.core.nth.call(null,v,(0)));var jsprops = (function (){var obj5480 = {};(obj5480[reagent.impl.util.cljs_argv] = v);
(obj5480[reagent.impl.util.cljs_level] = level);
return obj5480;
})();var k_5481 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));var k_SINGLEQUOTE__5482 = (((k_5481 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null)):k_5481);if((k_SINGLEQUOTE__5482 == null))
{} else
{(jsprops["key"] = k_SINGLEQUOTE__5482);
}
...
reagent.impl.template.expand_seq = (function expand_seq(s,level){var a = cljs.core.into_array.call(null,s);var level_SINGLEQUOTE_ = (level + (1));var n__4400__auto___5483 = a.length;var i_5484 = (0);while(true){
if((i_5484 < n__4400__auto___5483))
{(a[i_5484] = reagent.impl.template.as_component.call(null,(a[i_5484]),level_SINGLEQUOTE_));
{
...
reagent.impl.template.convert_args = (function convert_args(argv,first_child,level){var a = cljs.core.into_array.call(null,argv);var n__4400__auto___5486 = a.length;var i_5487 = (0);while(true){
if((i_5487 < n__4400__auto___5486))
{if((i_5487 >= first_child))
{(a[i_5487] = reagent.impl.template.as_component.call(null,(a[i_5487]),level));
} else
{}
{
